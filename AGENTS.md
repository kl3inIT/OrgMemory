...
- In a subproject with its own `AGENTS.md`, `CLAUDE.md`, `ARCHITECTURE.md`, or
  `docs/`, read the root guidance first and then the subproject guidance.
  Subproject detail must not be restated at root.
