 ...
 * open while its remaining sibling-module adapters and foreign Source Ledger persistence access
 * are replaced by intentional interfaces during the Knowledge module-closing phase. Asset and
 * Organization reads already cross owner-defined queries.
 */
