...
@Service
class JdbcEmbeddingProfileRegistry implements EmbeddingProfileRegistry {

    private final EmbeddingProfileRepository profiles;
    private final JdbcClient jdbc;

    JdbcEmbeddingProfileRegistry(EmbeddingProfileRepository profiles, JdbcClient jdbc) {
