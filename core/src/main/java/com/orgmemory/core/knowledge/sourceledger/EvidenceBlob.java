...
public class EvidenceBlob extends BaseEntity {
    ...
    public EvidenceBlob(UUID id, UUID organizationId, StoredObject stored) {
        super(id);
    ...
    public EvidenceScanStatus getScanStatus() {
        return scanStatus;
    }
}
