...
import com.orgmemory.core.knowledge.AclAuthority;
...
public class SourceObject extends BaseEntity {
    ...
    public static SourceObject connectorObject(
            UUID id,
            UUID organizationId,
            UUID knowledgeSpaceId,
            UUID departmentId,
    ...
    public void stageRevision(UUID revisionId) {
    ...
    public SourceObjectStatus getStatus() {
        return status;
    }
