 ...
 */
public record ConnectorContractVersions(
        String content,
        String identity,
        String membership,
        String permission) {
    ...
    static final String IDENTITY_V2 = "identity/v2";
    static final String MEMBERSHIP_V1 = "membership/v1";
    ...
    public static ConnectorContractVersions supported() {
        return new ConnectorContractVersions(
                CONTENT_V1,
                IDENTITY_V2,
                MEMBERSHIP_V1,
                PERMISSION_V1);
    ...
    void requireSupported() {
        ...
        requireKnown(identity, IDENTITY_V2, "identity");
        requireKnown(membership, MEMBERSHIP_V1, "membership");
    ...
    public boolean equals(Object other) {
        return other instanceof ConnectorContractVersions versions
                ...
                && membership.equals(versions.membership)
                && permission.equals(versions.permission);
    }

    @Override
    public int hashCode() {
        return Objects.hash(content, identity, membership, permission);
    }
}
