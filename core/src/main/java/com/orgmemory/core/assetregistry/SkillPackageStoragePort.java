...
public interface SkillPackageStoragePort {
    ...
    record SkillPackageWriteRequest(
        ...
        public SkillPackageWriteRequest {
            ...
            if (contentLength <= 0) {
                throw new IllegalArgumentException("Skill package content length must be positive");
            }
    ...
    record StoredSkillPackage(
        ...
        public StoredSkillPackage {
            ...
            if (contentLength <= 0) {
                throw new IllegalArgumentException("Stored Skill package length must be positive");
            }
