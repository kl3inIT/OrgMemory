...
| --- | --- | --- |
| [Assistant composer and conversation model picker](increments/active/2026-08-04-assistant-composer-model-picker/plan.md) | active | implement the challenged administrator-bound model authority, picker, and empty-state polish |
