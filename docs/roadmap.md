...
| --- | --- | --- |
| [Ingestion throughput](increments/active/2026-08-01-ingestion-throughput/plan.md) | active | bounded dependency-phased staging batches and bounded-burst schedulers behind adapter and worker tests |
