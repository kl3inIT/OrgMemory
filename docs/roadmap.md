...
| [Public docs hydration repair](increments/active/2026-08-01-docs-hydration/plan.md) | active | remove the route-dependent body mismatch and prove clean production hydration |
