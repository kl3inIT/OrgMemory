...
| --- | --- | --- |
| [Asset catalog layout balance](increments/active/2026-07-31-asset-catalog-layout-balance/plan.md) | active | cap the desktop scope selector, align trailing toolbar context, and pass browser design QA |
