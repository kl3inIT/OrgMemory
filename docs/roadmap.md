...
| --- | --- | --- |
| [Document View and Delete](increments/active/2026-08-02-document-view-delete/plan.md) | active | independent challenge, implementation, full verification, review, merge, and production proof; no Reindex action |
