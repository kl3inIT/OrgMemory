...
| --- | --- | --- |
| [Agentic Skill beta](increments/active/2026-08-05-agentic-skill-beta/plan.md) | active | deliver actor-scoped Skill discovery, activation, bounded resource reads, and a truthful read-only Assistant tool loop without server-side package execution |
