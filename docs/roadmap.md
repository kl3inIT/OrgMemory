...
| --- | --- | --- |
| [Effective access inspector](increments/active/2026-08-02-effective-access-inspector/plan.md) | active | align the admin verdict with canonical content visibility without leaking denied metadata, then replace identifier-first diagnostics |
