...
| --- | --- | --- |
| [Apache AGE published-batch backfill](increments/active/2026-08-03-apache-age-published-batch-backfill/plan.md) | active | independent architecture challenge, implementation, CI, and production proof |
