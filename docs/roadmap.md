...
| --- | --- | --- |
| [Assistant interaction foundation](increments/active/2026-08-04-assistant-interaction-foundation/plan.md) | active | reconcile current docs, run completion gates, and finish the PR/CI/review loop |
