...
| [Assistant answer behavior](increments/active/2026-08-05-assistant-answer-behavior/plan.md) | active | merge and deploy the permission-safe wording/citation prompt, then preserve deny 7/7 and reach citation >= 41/43 (target 43/43) in the owner-run production sweep |
