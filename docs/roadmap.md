...
| [Assistant private files](increments/active/2026-08-11-assistant-private-files/plan.md) | active implementation | implement the selected actor-private, retention-bounded file lane under the recorded owner waiver for malware/DLP |
