...
| [Assistant private files](increments/active/2026-08-11-assistant-private-files/plan.md) | active design | replace the paperclip's implicit Knowledge publication with actor-private, retention-bounded files while preserving governed publication as an explicit action |
