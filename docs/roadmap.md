...
| [Assistant private files](increments/active/2026-08-11-assistant-private-files/plan.md) | challenged — owner gate | implement the selected actor-private, retention-bounded file lane after choosing malware/DLP enforcement or an explicit temporary waiver |
