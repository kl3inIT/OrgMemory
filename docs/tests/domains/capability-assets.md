...
| Collection authorization and usage avoid per-row calls | `#listUsesSetAuthorizationInsteadOfPerAssetChecks`, `OpenFgaRelationshipAuthorizationSetAdapterTests#batchCheckSendsResourceSpecificContextualTuples` | covered |
