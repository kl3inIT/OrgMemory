# Effective Access Inspector Plan

- [x] Reproduce the production mismatch across OpenFGA, the canonical ledger,
  and the secure retrieval SQL.
- [x] Audit the existing UI against the supplied screenshots and repository
  design system.
- [ ] Complete the independent architecture challenge and record the decision.
