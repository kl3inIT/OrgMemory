# Skill consumer compatibility plan

## 0. Decision gate

- [x] Audit the existing release, CLI adapter, receipt, and handoff behavior.
- [x] Confirm Fable 5 is unavailable because the project owner reported quota exhaustion.
- [x] Run a fresh Codex `gpt-5.6-sol ultra` adversarial architecture challenge.
- [x] Record the verdict, final choice, strongest counterargument, and rejected alternative.
...
- [ ] Merge current `origin/main` before PR creation.
