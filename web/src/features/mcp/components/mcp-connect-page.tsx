...
const CLAUDE_CODE_COMMAND =
  "claude mcp add --transport http orgmemory https://om.kl3in.tech/mcp"
      ...
      <div className="mx-auto w-full max-w-5xl space-y-6 p-4 md:p-8">
        <header className="space-y-2">
          <div className="flex items-center gap-3">
            <span className="grid size-10 place-items-center rounded-xl bg-action-primary text-action-primary-foreground shadow-xs">
              <Plug className="size-5" aria-hidden="true" />
            </span>
            <div>
              <h1 className="text-page-title text-content-primary">Connect AI clients</h1>
              <p className="mt-1 max-w-2xl text-sm text-content-secondary">
                Use released OrgMemory Assets from your preferred assistant without
                copying content or credentials between products.
              </p>
            </div>
          </div>
        </header>
        ...
        <Card className="gap-4">
          <CardHeader>
            ...
            <CardDescription>
              One Streamable HTTP endpoint for Claude, Codex, and compatible MCP
              clients.
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <TabsContent value="claude">
            ...
            >
              <SetupStep number={1} title="Claude Web or Desktop">
                Open <strong>Settings → Connectors</strong>, add a custom connector,
                and paste the server URL above. Choose <strong>Connect</strong> and
                approve the read-only access request.
              </SetupStep>
              <SetupStep number={2} title="Claude Code">
                Run this once, then use <code>/mcp</code> inside Claude Code to sign
                in and inspect the connection.
          ...
          <TabsContent value="codex">
            ...
            >
              ...
              <SetupStep number={2} title="Sign in">
                Codex opens your browser for OrgMemory consent. The token remains in
                the client credential store.
          ...
          <TabsContent value="other">
            ...
            >
              ...
              <SetupStep number={3} title="Scope">
                ...
                access to every Asset, Pack item, and release.
              </SetupStep>
              <p className="rounded-lg border border-border-subtle bg-surface-subtle p-3 text-sm text-content-secondary">
                Loopback callbacks are supported for local clients. A hosted client
                with another callback domain needs an administrator to approve that
                domain first.
              </p>
            </ClientCard>
          </TabsContent>
        ...
        <Card className="gap-4 border-status-info-border bg-status-info-surface/40">
          <CardHeader>
            ...
            <CardDescription>
              Search authorized Assets, read exact releases and Pack contents, resolve
              relations, and render released Prompt templates with variables.
            </CardDescription>
          </CardHeader>
