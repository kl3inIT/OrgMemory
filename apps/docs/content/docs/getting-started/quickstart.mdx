...
description: Follow the shortest verified path from a clean checkout to an Organizational AI Memory demonstration.
audience:
  - adopter
  - developer
  - evaluator
...
OpenFGA enabled; Organizational AI Memory has no permit-all development profile.
