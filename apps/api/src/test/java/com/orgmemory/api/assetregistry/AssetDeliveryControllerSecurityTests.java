...
class AssetDeliveryControllerSecurityTests {
    ...
    void readEndpointsRejectTokensWithoutAssetsReadScope() {
        Authentication authentication = authentication("SCOPE_assets:use");
    ...
    @Test
    void promptRenderRejectsTokensWithoutAssetsUseScope() {
        Authentication authentication = authentication("SCOPE_assets:read");
        SecurityContextHolder.getContext().setAuthentication(authentication);
