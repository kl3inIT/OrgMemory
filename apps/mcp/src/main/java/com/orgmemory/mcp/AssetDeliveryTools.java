...
class AssetDeliveryTools {
    ...
    AssetDeliveryTools(AssetDeliveryApiClient assets) {
        this.assets = assets;
    }
    ...
    @McpTool(
            ...
            annotations = @McpAnnotations(
                    ...
                    idempotentHint = true,
                    openWorldHint = false))
    List<AssetDeliveryApiClient.AssetSummary> searchAssets(
        ...
        return assets.search(McpBearer.require(context), query, type);
    }
    ...
    AssetDeliveryApiClient.AssetRelease getAsset(
            ...
            McpTransportContext context) {
        return assets.getAsset(McpBearer.require(context), assetId);
    }
    ...
    AssetDeliveryApiClient.AssetRelease getAssetRelease(
        ...
        return assets.getRelease(
                McpBearer.require(context), assetId, releaseId);
    }
